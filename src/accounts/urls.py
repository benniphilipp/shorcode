...
from .views import home, RegisterView, CustomLoginView, ResetPasswordView, UserProfileView, save_click_data
...
urlpatterns = [
    ...
    path('api/v1/save_click_data/', save_click_data, name='save_click_data'),
]